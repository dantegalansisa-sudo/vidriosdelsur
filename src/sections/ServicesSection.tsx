...
const services = [
  {
    ...
    image: '/imagenes/Ventanas de Cristal y Aluminio.webp',
    tag: 'Más Popular',
  },
  {
    icon: '🚪',
  ...
  },
  {
    ...
    image: '/imagenes/Corte de Vidrio a Medida.jpg',
  },
  {
    icon: '🔧',
    ...
    image: '/imagenes/Repuestos Generales.jpg',
  },
];
